...
if file=="econbiz":
    ...
    y_label=y_matrix(file,folds,t)  #Y matrix
...
def create_model():
    ...
    model.add(Embedding(len(word_index) + 1,
                                ...
                                input_length=max,
                                trainable=False))
    model.add(LSTM(neurons))    #LSTM layer
...
#results=results_path+"\\lstm_t"+str(t)+"_"+file+".txt"
#res = open(results,'w')
